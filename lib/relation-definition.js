...
HasMany.prototype.removeFromCache = function (id, options) {
  var cache = this.modelInstance.__cachedRelations[this.definition.name];
  var modelTo = this.definition.modelTo;
  if (modelTo && modelTo.getOverridenModel) {
    modelTo = modelTo.getOverridenModel(options);
  }
  var idName = modelTo.definition.idName();
...
HasMany.prototype.addToCache = function (inst, options) {
  if (!inst) {
    return;
  }
  var cache = this.modelInstance.__cachedRelations[this.definition.name];
...
RelationDefinition.hasMany = function hasMany(modelFrom, modelTo, params) {
  ...
  defineScope(modelFrom.prototype, params.through || modelTo, relationName, function () {
    var filter = {};
    filter.where = {};
    filter.where[fk] = {inq: [this[pkName]]};
...
HasMany.prototype.destroyById = function (fkId, options, cb) {
  ...
  this.findById(fkId, options, function (err, inst) {
    ...
    self.removeFromCache(fkId, options);
...
HasManyThrough.prototype.create = function create(data, options, cb) {
  ...
  modelTo.create(data, options, function (err, to) {
    ...
    var pk2 = modelTo.definition.idName();
...
HasManyThrough.prototype.add = function (acInst, data, options, cb) {
  ...
  query[fk2] = (acInst instanceof modelTo) ? acInst[pk2] : acInst;
  ...
  data[fk2] = (acInst instanceof modelTo) ? acInst[pk2] : acInst;
  ...
  modelThrough.findOrCreate(filter, data, options, function (err, ac) {
    if (!err) {
      if (acInst instanceof modelTo) {
        self.addToCache(acInst, options);
      }
    }
    cb(err, ac);
  });
...
HasManyThrough.prototype.remove = function (acInst, options, cb) {
  ...
  modelThrough.deleteAll(filter.where, options, function (err) {
    if (!err) {
      self.removeFromCache(query[fk2], options);
    }
    cb(err);
  });
  return cb.promise;
...
BelongsTo.prototype.build = function (targetModelData, options) {
  var modelTo = this.definition.modelTo;
  if (modelTo && modelTo.getOverridenModel) {
    modelTo = modelTo.getOverridenModel(options);
  }
...
HasMany.prototype.create = function (targetModelData, options, cb) {
  ...
  modelTo.create(targetModelData, options, function (err, targetModel) {
    if (!err) {
      //Refresh the cache
      apply(targetModel, self.addToCache.bind(self, options));
      cb && cb(err, targetModel);
    } else {
      cb && cb(err);
    }
 ...
 */
HasMany.prototype.build = HasOne.prototype.build = function (targetModelData, options) {
  var modelTo = this.definition.modelTo;
  if (modelTo && modelTo.getOverridenModel) {
    modelTo = modelTo.getOverridenModel(options);
  }
...
EmbedsOne.prototype.create = function (targetModelData, options, cb) {
  ...
  var result = checkParentVersion(this.definition.modelFrom.settings.mixins, modelInstance, targetModelData)
  if (result instanceof Error) {
    return cb(result);
  }

  var data = {};
  if (isVersionMixinApplied(this.definition.modelFrom.settings.mixins)) {
    data._version = targetModelData._parentVersion;
    targetModelData.unsetAttribute ? targetModelData.unsetAttribute('_parentVersion') : delete targetModelData._parentVersion;
  }
  var inst = this.callScopeMethod('build', targetModelData, options);
  data[propertyName] = inst.toObject();
  ...
  var updateEmbedded = function () {
    if (modelInstance.isNewRecord()) {
      ...
      modelInstance.updateAttributes(data, options, function (err, inst) {
        cb(err, err ? null : inst);
      });
    }
  };
...
EmbedsOne.prototype.build = function (targetModelData, options) {
  var modelTo = this.definition.modelTo;
  if (modelTo && modelTo.getOverridenModel) {
    modelTo = modelTo.getOverridenModel(options);
  }
...
EmbedsOne.prototype.update = function (targetModelData, options, cb) {
  ...
  if (embeddedInstance instanceof modelTo) {
    ...
    var updateData = {};
    if (isVersionMixinApplied(this.definition.modelFrom.settings.mixins)) {
      updateData._version = targetModelData._parentVersion;
      targetModelData.unsetAttribute ? targetModelData.unsetAttribute('_parentVersion') : delete targetModelData._parentVersion;
    }
    var inst = this.callScopeMethod('build', targetModelData, options);
    updateData[propertyName] = inst.toObject();
    if (typeof cb === 'function') {
      modelInstance.updateAttributes(updateData, options, function (err, inst) {
    ...
    return this.callScopeMethod('build', data, options);
  }
  return cb.promise;
};
...
EmbedsMany.prototype.prepareEmbeddedInstance = function (inst, options) {
...
EmbedsMany.prototype.embeddedList =
  EmbedsMany.prototype.embeddedValue = function (options, modelInstance) {
    modelInstance = modelInstance || this.modelInstance;
    var embeddedList = modelInstance[this.definition.keyFrom] || [];
    embeddedList.forEach(this.prepareEmbeddedInstance.bind(this, options));
    return embeddedList;
  };
...
EmbedsMany.prototype.related = function (receiver, scopeParams, condOrRefresh, options, cb) {
  ...
  var embeddedList = this.embeddedList(options, receiver);
...
EmbedsMany.prototype.updateById = function (fkId, data, options, cb) {
  ...
  var propertyName = this.definition.keyFrom;
  var modelInstance = this.modelInstance;
  var result = checkParentVersion(this.definition.modelFrom.settings.mixins, modelInstance, data);
  if (result instanceof Error) {
    return cb(result);
  }
  var embeddedList = this.embeddedList();
  ...
  if (inst instanceof modelTo) {
    ...
    var updateData = {};
    updateData[propertyName] = embeddedList;
    if (isVersionMixinApplied(this.definition.modelFrom.settings.mixins)) {
      updateData._version = data._parentVersion;
      delete data._parentVersion;
      inst.unsetAttribute('_parentVersion');
    }
    if (typeof cb === 'function') {
      modelInstance.updateAttributes(updateData, options, function (err) {
        cb(err, inst);
      });
    }
...
EmbedsMany.prototype.destroyById = function (fkId, options, cb) {
  ...
  if (inst instanceof modelTo) {
    ...
    if (typeof cb === 'function') {
      var data = {};
      data[propertyName] = embeddedList;
      if (isVersionMixinApplied(this.definition.modelFrom.settings.mixins)) {
        data._version = modelInstance._version;
      }
      modelInstance.updateAttributes(data, options, function (err) {
        cb(err);
...
EmbedsMany.prototype.build = function (targetModelData, options) {
  var modelTo = this.definition.modelTo;
  if (modelTo && modelTo.getOverridenModel) {
    modelTo = modelTo.getOverridenModel(options);
  }
  ...
  this.prepareEmbeddedInstance(inst, options);
...
EmbedsMany.prototype.add = function (acInst, data, options, cb) {
  ...
  belongsTo.modelTo.findOne(filter, options, function (err, ref) {
    if (ref instanceof belongsTo.modelTo) {
      var inst = self.build(data || {}, options);
...
ReferencesMany.prototype.build = function (targetModelData, options) {
  var modelTo = this.definition.modelTo;
  if (modelTo && modelTo.getOverridenModel) {
    modelTo = modelTo.getOverridenModel(options);
  }
...
ReferencesMany.prototype.remove = function (acInst, options, cb) {
  ...
  var id = (acInst instanceof modelTo) ? acInst[pk] : acInst;
...
function checkParentVersion(mixins, modelInstance, targetModelData) {
  if (isVersionMixinApplied(mixins)) {
    if (targetModelData._parentVersion) {
      if (modelInstance._version !== targetModelData._parentVersion) {
        return (new Error('worng parent version'));
      }
    } else {
      return (new Error('Please provide parent version. \'_parentVersion\''));
    }
  }
  return;
};

function isVersionMixinApplied(mixins) {
  if (mixins && mixins.VersionMixin) {
    return true;
  }
  return false;
}